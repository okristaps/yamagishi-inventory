  ...
  return (
    <div ref={containerRef} className="p-6">
      <div className="max-w-4xl mx-auto">
        ...
        {/* Keyboard Avoiding Form Test */}
        <Card className="mb-6">
          <CardHeader>
            <CardTitle>Keyboard Avoiding Form Test</CardTitle>
            <CardContent className="!mt-0 !p-0">
              <p className="text-sm text-gray-600 dark:text-gray-300">
                Try tapping on inputs below to test keyboard avoiding behavior. The focused input should scroll into view.
              </p>
            </CardContent>
          </CardHeader>
          <CardContent>
          ...
          <CardHeader>
            ...
            <CardContent className="!mt-0 !p-0">
              <p className="text-gray-600 dark:text-gray-300">
                This additional content helps test the scrolling behavior. You should be able to scroll through all sections.
              </p>
            </CardContent>
          </CardHeader>
          <CardContent>
            <div className="grid grid-cols-2 gap-4">
              <Card variant="outline" padding="sm" className="bg-blue-50 dark:bg-blue-900/20">
                <h3 className="font-medium text-blue-900 dark:text-blue-200">Feature 1</h3>
                <p className="text-blue-700 dark:text-blue-300 text-sm">Description of feature 1</p>
              </Card>
              <Card variant="outline" padding="sm" className="bg-green-50 dark:bg-green-900/20">
                <h3 className="font-medium text-green-900 dark:text-green-200">Feature 2</h3>
                <p className="text-green-700 dark:text-green-300 text-sm">Description of feature 2</p>
              </Card>
              <Card variant="outline" padding="sm" className="bg-purple-50 dark:bg-purple-900/20">
                <h3 className="font-medium text-purple-900 dark:text-purple-200">Feature 3</h3>
                <p className="text-purple-700 dark:text-purple-300 text-sm">Description of feature 3</p>
              </Card>
              <Card variant="outline" padding="sm" className="bg-orange-50 dark:bg-orange-900/20">
                <h3 className="font-medium text-orange-900 dark:text-orange-200">Feature 4</h3>
                <p className="text-orange-700 dark:text-orange-300 text-sm">Description of feature 4</p>
              </Card>
            </div>
          </CardContent>
        </Card>
